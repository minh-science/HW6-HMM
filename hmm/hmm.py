...
# print(hmm_forward.forward(input_observation_states= hmm_forward.observation_states))
print(hmm_forward.forward(input_observation_states= observation_state_sequence ) )